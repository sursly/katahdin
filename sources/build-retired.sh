...
fontmake -g sources/Katahdin-Round.glyphs -i -o ttf --output-dir ./fonts/static/ttf/
fontmake -g sources/Katahdin-Round.glyphs -i -o otf --output-dir ./fonts/static/otf/
